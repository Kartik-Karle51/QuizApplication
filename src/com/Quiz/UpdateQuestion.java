		...
		add.addActionListener(new ActionListener() {
			...
			if(ques.getText().length()>0 && opt1.getText().length()>0 && opt2.getText().length()>0 && opt3.getText().length()>0 && opt4.getText().length()>0 && ans.getText().length()>0) {	
				try {
					...
					PreparedStatement ps=c.con.prepareStatement("Update AddQuestion set question='"+ques.getText()+"',opt1='"+opt1.getText()+"',opt2='"+opt2.getText()+"',opt3='"+opt3.getText()+"',opt4='"+opt4.getText()+"',ans='"+ans.getText()+"'where id='"+lid.getText()+"'");
